...
<meta http-equiv="content-type" content="text/html;charset=utf-8">
 ...
 <title>FINANCE-Log In</title>
  <script src="includes/yahoo-min.js"></script> 
  <script src="includes/event-min.js"></script> 
  <script src="includes/connection-min.js"></script> 
...
// NOW USE AJAX TO SEND DATA TO INTE INTERCEPTOR PAGE "login.php"
 ...
 <div id="middle" >
   ...
   <form name="loginform" method="POST" action="" onsubmit="return validate();return false;" accept-charset="utf-8">
     ...
     <div id="logindetails">
       <br/><br/>
       <spand id="userspan"><b>User Name :</b><input type="text" charset="utf-8" id="uname" name="uname" class="textual"/></span>
       <br/><br/>
